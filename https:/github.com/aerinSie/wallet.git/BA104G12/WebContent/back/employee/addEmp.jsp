...
<hr>
								<div style="background-color: #E0E0E0;text-align:center" id="msg" ></div>
					...
					<button class="btn btn-success" onclick="addEmp() ">
						<span>magic</span>
				</div>
				</button>
...
<script type="text/JavaScript">
	...
	function showMessage() {
		document.getElementById("submit").innerHTML = '資料庫連線中...';
		document.getElementById("msg").innerHTML = '帳號建立中，密碼正發送至該員工註冊信箱<i style="font-size:16px;color:red;" class="fa fa-spinner fa-spin fa-3x fa-fw"></i>';
