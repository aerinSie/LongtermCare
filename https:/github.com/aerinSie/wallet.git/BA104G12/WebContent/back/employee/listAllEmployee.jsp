							...
							<div class="col-xs-12 col-sm-12">
								...
								<div class="col-xs-1 col-sm-1">
									<a
										...
										role="button"><span class="glyphicon glyphicon-save"></span>&nbsp;新增員工</a>
								</div>
							</div>
							<div class="col-sm-12">
								<table class="table ">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="well form-horizontal"
							action="<%=request.getContextPath()%>/employee/employee.do?action=modifyManager"
							...
							<fieldset>
									...
									<div class="col-md-4 selectContainer">
										<div class="input-group">
											<select name="empDep" class="form-control selectpicker">
												<option value="長照"
													${empVO.empDep.equals("長照") ?"selected" :"" }>長照部門</option>
												<option value="派車"
													${empVO.empDep.equals("派車") ?"selected" :"" }>派車部門</option>
												<option value="送餐"
													${empVO.empDep.equals("送餐") ?"selected" :"" }>送餐部門</option>
												<option value="後勤"
													${empVO.empDep.equals("後勤") ?"selected" :"" }>後勤部門</option>
											</select>
										</div>
									</div>
								</div>
									...
									<div class="col-md-4 selectContainer">
										<div class="input-group">
											<select name="empBranches" class="form-control selectpicker">
												<option value="10"
													${empVO.empBranches.equals("10") ?"selected" :"" }>台北分部</option>
												<option value="20"
													${empVO.empBranches.equals("20") ?"selected" :"" }>桃園分部</option>
												<option value="30"
													${empVO.empBranches.equals("30") ?"selected" :"" }>台中分部</option>
												<option value="40"
													${empVO.empBranches.equals("40") ?"selected" :"" }>台南分部</option>
												<option value="50"
													${empVO.empBranches.equals("50") ?"selected" :"" }>高雄分部</option>
											</select>
										</div>
									</div>
								</div>
									...
									<div class="col-md-4 selectContainer">
										<div class="input-group">
											<select name="empTitle" class="form-control selectpicker">
												<option value="總經理"
													${empVO.empTitle.equals("總經理") ?"selected" :"" }>總經理</option>
												<option value="分部經理"
													${empVO.empTitle.equals("分部經理") ?"selected" :"" }>分部經理</option>
												<option value="專員"
													${empVO.empTitle.equals("專員") ?"selected" :"" }>分部專員</option>
											</select>
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-4 selectContainer">
										<div class="input-group">
											<select name="authorityNo" class="form-control selectpicker" value="${empVO.authorityNo}">
												<option value="總經理"
													${empVO.authorityNo.equals("總經理") ?"selected" :"" }>總經理</option>
												<option value="部門經理"
													${empVO.authorityNo.equals("部門經理") ?"selected" :"" }>部門經理</option>
												<option value="管理員"
													${empVO.authorityNo.equals("管理員") ?"selected" :"" }>管理員</option>
												<option value="派車人員"
													${empVO.authorityNo.equals("派車人員") ?"selected" :"" }>派車人員</option>
												<option value="長照人員"
													${empVO.authorityNo.equals("長照人員") ?"selected" :"" }>長照人員</option>
												<option value="送餐人員"
													${empVO.authorityNo.equals("送餐人員") ?"selected" :"" }>送餐人員</option>
											</select>
										</div>
									</div>
								</div>
									...
									<div class="col-md-4 selectContainer">
										<div class="input-group">
											<select name="empStatus" class="form-control selectpicker">
												<option value="on"
													${empVO.empStatus.toLowerCase().equals("on") ?"selected":""}>就職中</option>
												<option value="off"
													${empVO.empStatus.toLowerCase().equals("on") ?"" :"selected"}>離職</option>
											</select>
										</div>
									</div>
								</div>
